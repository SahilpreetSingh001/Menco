                ...
                <div className="container mx-auto my-20 pt-8">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6">
                        <div className="flex justify-between items-center">
                            <div className="w-2/3">
                                <h1 className="text-2xl font-bold text-[#580092]">Randhir Singh</h1>
                                <p className="text-gray-600">Applied Science</p>
                            ...
                            <div className="w-1/3 bg-gray-200 h-80">
                                <img src="./randhirsingh.jpg" className='w-full h-full' alt="Mentor" />
                            </div>
                        </div>
